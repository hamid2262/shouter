...
class VehicleModelsControllerTest < ActionController::TestCase
  ...
  test "should create vehicle_model" do
    assert_difference('VehicleModel.count') do
      post :create, vehicle_model: { default_image: @vehicle_model.default_image, name: @vehicle_model.name, seats_number: @vehicle_model.seats_number, up_view_image: @vehicle_model.up_view_image, vehicle_brand_id: @vehicle_model.vehicle_brand_id }
    end
  ...
  test "should update vehicle_model" do
    patch :update, id: @vehicle_model, vehicle_model: { default_image: @vehicle_model.default_image, name: @vehicle_model.name, seats_number: @vehicle_model.seats_number, up_view_image: @vehicle_model.up_view_image, vehicle_brand_id: @vehicle_model.vehicle_brand_id }
    assert_redirected_to vehicle_model_path(assigns(:vehicle_model))
  end
